...
function getToken(obj){
	$.ajax({
		url: "http://ceclnx01.cec.miamioh.edu/~birdaj/cse383/final-project/datarecorder/rest.php/v1/user",
		type: "POST", 
		dataType: "JSON",
...
function getButtons(){
	$.ajax({
		url: "http://ceclnx01.cec.miamioh.edu/~birdaj/cse383/final-project/datarecorder/rest.php/v1/items",
		type: "GET",
		dataType : "JSON",
		success: function (text){
			var stat = ""; 
...
function getData(){
	$.ajax({
		url: "http://ceclnx01.cec.miamioh.edu/~birdaj/cse383/final-project/datarecorder/rest.php/v1/itemsSummary/" + tokenAuth,
		type: "GET",
		dataType : "JSON",
		success: function (text){
			var stat = ""; 
...
function getItemsData(){
	const tokenUrl = "http://ceclnx01.cec.miamioh.edu/~birdaj/cse383/final-project/datarecorder/rest.php/v1/items/" + tokenAuth;
	// alert(tokenUrl)
	$.ajax({
		url: tokenUrl,
		type: "GET",
